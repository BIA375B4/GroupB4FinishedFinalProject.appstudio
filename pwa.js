...
const cacheName = 'Test-2021-04-28 16:57:21.843570'; // unique value, generated each deploy
const contentToCache = [
  'index.html',
  'code.js',
  'style.css',
  'app.js',
  'images/billy-bluejay.jpg',
  'images/69524.png',
  'images/yelp-logo-e1569950418653.png',
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'Test'.length) === 'Test') {
